...
//Especifica que la variable diagnoses debe ser un array ([]) cuyos elementos 
// son del tipo Diagnosis (la interfaz que definiste para tus diagnósticos).
//Este es un concepto fundamental en TypeScript (TS), llamado Type Annotation, 
// que ayuda al compilador de TS a verificar que todos los datos dentro de ese
//  array cumplan con la estructura definida por la interfaz Diagnosis.
